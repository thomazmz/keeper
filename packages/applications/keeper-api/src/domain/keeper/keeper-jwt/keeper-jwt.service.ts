...
import { KeeperJwtConfigRecord } from './keeper-jwt.config'
...
export class KeeperJwtService {
  ...
  private readonly keeperJwtConfig: KeeperJwtConfigRecord;

  public constructor(keeperJwtConfig: KeeperJwtConfigRecord) {
    this.keeperJwtConfig = keeperJwtConfig
  }
